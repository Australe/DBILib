...
{**
  ...
  Project:       DBILib
  Files(s):      DBIFileStreams.pas
  Classes:       TDBIHandleStream, TDBIFileStream
...
{$ifndef fpc}
  Consts,
{$endif}
  Classes, SysUtils, Windows, DBIConst, DBIUtils;
...
const
  Unitname = 'DBIFileStreams';


// =============================================================================
// 'TDBIBufferedHandleStream' methods
// =============================================================================
...
procedure TDBIHandleStream.Error(
  E: Exception;
  const Caller: String;
  const Reference: String;
  const ErrMsg: String;
...
// =============================================================================
// 'TDBIBufferedFileStream' public methods
// =============================================================================

...
{**
  ...
  Project:       DBIcl
  Files(s):      DBIMemoryStreams
  Classes:       TDBIVirtualMemoryStream, TDBIMemoryMappedFile
  Author:        John Vander Reest
  Purpose:       Virtual memory versions of TMemoryStream (Windows only)
...
type
  TDBIMemoryMappedFile = class(TObject)
  private
    FFileName: String;
    FMode: Word;
    FHandle: Integer;

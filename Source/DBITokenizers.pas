...
type
  ...
  public
    constructor Create(AParams: TParams); virtual;
...
type
  ...
  private
    ...
    FName: String;
    FParams: TParams;
    FParamsAdapter: TDBIParamsAdapter;
...
begin
  ...
  FParamsAdapter := TDBIParamsAdapter.Create(FParams);
end;
...
constructor TDBIParamsAdapter.Create(AParams: TParams);
begin
  inherited Create;

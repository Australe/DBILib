...
{**
  ...
  Purpose:       DBIInterface constants
...
const
  ...
  sizeofWORD      =  2;                // Word
  sizeofDWORD     =  4;                // DWord
  sizeofBOOL      =  2;                // Boolean
  sizeofFLOAT     =  8;                // Double
  sizeofCURRENCY  =  8;                // Double
  sizeofBCD       = SizeOf(TBcd); {18} // BCD
  sizeofDATE      =  8;                // TTimeStamp
  sizeofTIME      =  8;                // TTimeStamp
  sizeofDATETIME  =  8;                // TTimeStamp
  sizeofBYTES     = -1;                // N/A
  sizeofVARBYTES  = -1;                // N/A
  sizeofAUTOINC   =  4;                // Int32
  sizeofBLOB      =  4;                // Pointer
  sizeofMEMO      =  4;                // Pointer
  sizeofTABLE     =  4;                // Pointer
  sizeofADT       =  4;                // Pointer
  sizeofINT64     =  8;                // Int64
//##JVR  sizeofINT32     =  4;                // Int32
  sizeofDOUBLE    =  8;                // Double
